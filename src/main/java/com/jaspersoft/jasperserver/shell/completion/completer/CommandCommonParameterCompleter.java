 ...
 */
public class CommandCommonParameterCompleter extends StringsCompleter {

    private List<String> params = new ArrayList<>();

    public CommandCommonParameterCompleter() {
        // empty
    }

    public CommandCommonParameterCompleter(String... params){
